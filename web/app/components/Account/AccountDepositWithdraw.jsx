            ...
            <div className={this.props.contained ? "" : "grid-content"}>
                <div style={{borderBottom: "2px solid #444", paddingTop: 40}}>
                    ...
                    <div className="button-group">
                        ...
                        <div className={cnames("button", currentCoin === "OPEN.BTC" ? "active" : "outline")} onClick={this.setCurrentCoin.bind(this, "OPEN.BTC")}>BTC</div>
                        <div className={cnames("button", currentCoin === "OPEN.ETH" ? "active" : "outline")} onClick={this.setCurrentCoin.bind(this, "OPEN.ETH")}>ETH</div>
			<div className={cnames("button", currentCoin === "OPEN.LTC" ? "active" : "outline")} onClick={this.setCurrentCoin.bind(this, "OPEN.LTC")}>LTC</div>
                    </div>
                </div>
